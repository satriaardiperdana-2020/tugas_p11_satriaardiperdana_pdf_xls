<?php 
 ...
 header("Conten-Disposition: attachment; filename=satria.xls");
	...
	<table border="1" width="100%" style="border-collapse: collapse;">
		...
		if($results->num_rows() > 0){
			...
			<tr>
				...
				<th align="center" style="padding:3px 5px">UAS</th>
			</tr>
			<?php
			...
			?>
				<tr>
					<td>Unfortunately, an error occured.</td>
				</tr>
			<?php
		}
		?>
